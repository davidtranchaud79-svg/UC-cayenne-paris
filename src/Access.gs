...
function sendMemberAccessEmail_(issued) {
  ...
  const body = [
    ...
    '',
    'IMPORTANT — Règle concernant les excuses :',
    'Pour tous les membres, jeunes et compagnons inclus, une excuse ne sera prise en compte que si elle est enregistrée directement dans ce formulaire.',
    'Les excuses transmises par une voie intermédiaire ne seront plus considérées comme valables ni acceptées : message oral transmis par un autre compagnon ou membre, email adressé à la messagerie Gmail de l’UC, au président ou à un autre responsable, SMS, WhatsApp ou tout autre canal parallèle.',
    'Exception : les membres âgés de 80 ans et plus pourront continuer à transmettre leurs excuses par la voie traditionnelle.',
    'Pour tous les autres membres, seul l’enregistrement dans le formulaire fera foi.',
    '',
